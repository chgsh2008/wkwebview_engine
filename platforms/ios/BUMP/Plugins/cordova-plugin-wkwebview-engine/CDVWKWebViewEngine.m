...
@property (nonatomic, strong, readwrite) id <WKNavigationDelegate> wkNavigationDelegate;
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.wkNavigationDelegate = [[CDVWKNavigationDelegate alloc] initWithEnginePlugin:self];
