 ...
 *
 */
define(['zepto', 'underscore', 'com.infinitus.butterfly/components/loader',
        'com.infinitus.butterfly/components/cache', 'iScroll', 'backbone',
        'com.infinitus.butterfly/components/list'],
    function($, _, Loader, Cache, iScroll, Backbone, List) {
